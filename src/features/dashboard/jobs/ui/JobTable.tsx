...
import { Actions, JobFilterParameters, PaginatedResponse } from "../types";
...
interface Props {
  ...
  parameters: JobFilterParameters & Actions;

}

function JobTable({ orders, loadingOrders, fetchOrders, parameters }: Props) {
