...
import { Heart, User, Mail, MessageCircle, CheckCircle, ArrowLeft, ArrowRight, Shield, Clock } from 'lucide-react';
    ...
    const isStepValid = (step: number): boolean => {
        switch (step) {
            case 0:
                return true;
            case 1:
                return formData.email !== '' && formData.confirmEmail !== '' && formData.reason !== '';
            case 2:
                return formData.confirmUnderstanding && formData.confirmBackup && formData.confirmIrreversible;
            default:
                return false;
        }
    };
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 flex items-center justify-center p-4">
                <div className="bg-white rounded-3xl shadow-xl p-8 max-w-lg w-full text-center border border-green-200">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">We've Received Your Request</h2>
                    <p className="text-gray-600 mb-4 leading-relaxed">
                        Thank you for letting us know. We're sorry to see you go! Your account deletion
                        request is being processed and you'll hear from us within 5-7 business days.
                    </p>
                    ...
                    <p className="text-sm text-gray-500 mb-6">
                        Changed your mind? You can still contact our support team within the next 7 days
                ...
                return (
                    <div className="space-y-6">
                        <div className="text-center mb-8">
                            ...
                            <h3 className="text-2xl font-bold text-gray-900 mb-3">We're sorry to see you go!</h3>
                            <p className="text-gray-600 text-lg">
                                Before you delete your account, let us help you explore other options.
                            </p>
                        </div>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-200">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                        <p className="font-medium text-blue-900">Pause your account instead</p>
                                        <p className="text-blue-700 text-sm">Take a break without losing your data</p>
                                    </div>
                                </div>
                                <div className="flex items-start space-x-3">
                                    <div className="w-6 h-6 bg-blue-200 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                                    ...
                                    <div>
                                        <p className="font-medium text-blue-900">Contact our support team</p>
                                        <p className="text-blue-700 text-sm">We're here to help resolve any issues</p>
                                    </div>
                                </div>
                                <div className="flex items-start space-x-3">
                                    <div className="w-6 h-6 bg-blue-200 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                                    ...
                                    <div>
                                        <p className="font-medium text-blue-900">Adjust your privacy settings</p>
                                        <p className="text-blue-700 text-sm">Customize what data you share</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                            <h4 className="font-semibold text-yellow-800 mb-2">⚠️ Just so you know...</h4>
                            <p className="text-yellow-700 text-sm leading-relaxed">
                                Deleting your account will permanently remove all your data, including your profile,
                                saved preferences, and any content you've created. This action cannot be undone,
                                and you'll need to create a new account if you want to use our service again.
                            </p>
                        </div>

                        <div className="bg-gray-50 rounded-lg p-4">
                            <h4 className="font-semibold text-gray-900 mb-3">What you'll lose:</h4>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                {formData.confirmEmail !== '' && formData.email !== formData.confirmEmail && (
                                    <p className="text-red-500 text-sm mt-1">Email addresses don't match</p>
                                )}
                            </div>
                        ...
                        <div className="bg-blue-50 rounded-lg p-4">
                            <p className="text-blue-800 text-sm">
                                💭 <strong>Your privacy matters:</strong> This information will only be used to improve our service
                                and will be deleted along with your account.
                            </p>
                        </div>
                    </div>
                );
                ...
                return (
                    <div className="space-y-6">
                        <div className="text-center mb-6">
                            ...
                            <p className="text-gray-600">
                                Please confirm you understand what will happen when we delete your account.
                            </p>
                        </div>
                        ...
                        <div className="space-y-4">
                            <label className="flex items-start space-x-3 cursor-pointer p-3 rounded-lg hover:bg-gray-50 transition-colors">
                                ...
                                <span className="text-sm text-gray-700 leading-relaxed">
                                    <strong>I understand this is permanent.</strong> Once deleted, my account and all data
                                    cannot be recovered, and I'll need to create a new account to use this service again.
                                </span>
                            </label>
                            ...
                            <label className="flex items-start space-x-3 cursor-pointer p-3 rounded-lg hover:bg-gray-50 transition-colors">
                                <input
                                    ...
                                    onChange={(e) => handleInputChange('confirmBackup', e.target.checked)}
                                    className="mt-1 w-5 h-5 text-red-600 border-gray-300 rounded focus:ring-red-500"
                                />
                                <span className="text-sm text-gray-700 leading-relaxed">
                                    <strong>I've saved what I need.</strong> I have backed up or saved any important
                                    information I want to keep from my account.
                                </span>
                            </label>
                            ...
                            <label className="flex items-start space-x-3 cursor-pointer p-3 rounded-lg hover:bg-gray-50 transition-colors">
                                <input
                                    ...
                                    onChange={(e) => handleInputChange('confirmIrreversible', e.target.checked)}
                                    className="mt-1 w-5 h-5 text-red-600 border-gray-300 rounded focus:ring-red-500"
                                />
                                <span className="text-sm text-gray-700 leading-relaxed">
                                    <strong>I'm sure about this decision.</strong> I want to permanently delete my account
                                    and understand this action cannot be undone.
                                </span>
                            </label>
                        </div>
                        ...
                        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                            <div className="flex items-center space-x-2 mb-2">
                                ...
                                <span className="font-medium text-green-900">What happens next?</span>
                            </div>
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                        <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-6">
                            <div className="text-center mb-6">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-2">One final check</h3>
                                <p className="text-gray-600">
                            ...
                            <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-6">
                                <p className="text-orange-800 text-sm leading-relaxed">
                                    <strong>Ready to delete your account?</strong> This will permanently remove all your data.
                                    We'll miss you, but we understand if you need to go.
                                </p>
                            </div>

                            <div className="text-center mb-6">
                                <p className="text-sm text-gray-600">
                                    Account: <strong className="text-gray-900">{formData.email}</strong>
                                </p>
                            </div>
